(function( $ ) {
   ...
   $(document).ready( function() {
      ...
      // Wider Admin Menu => show/hide subfields on document ready
      if ( document.getElementById('admin_site_enhancements[wider_admin_menu]').checked ) {
         $('.wider-admin-menu .asenha-subfields').show();
         $('.wider-admin-menu .asenha-subfield-select-inner').show();
         $('.asenha-toggle.wider-admin-menu td .asenha-field-with-options').addClass('is-enabled');  
      } else {
         $('.wider-admin-menu .asenha-subfields').hide();        
         $('.wider-admin-menu .asenha-subfield-select-inner').hide();
      }

      // Wider Admin Menu => show/hide subfields on toggle click
      document.getElementById('admin_site_enhancements[wider_admin_menu]').addEventListener('click', event => {
         if (event.target.checked) {
            $('.wider-admin-menu .asenha-subfields').fadeIn();
            $('.wider-admin-menu .asenha-subfield-select-inner').show();
            $('.wider-admin-menu .asenha-field-with-options').toggleClass('is-enabled');
         } else {
            $('.wider-admin-menu .asenha-subfields').hide();
            $('.wider-admin-menu .asenha-subfield-select-inner').hide();
            $('.wider-admin-menu .asenha-field-with-options').toggleClass('is-enabled');
      ...
      // Email Address Obfuscator => show/hide subfields on document ready
      if ( document.getElementById('admin_site_enhancements[obfuscate_email_address]').checked ) {
         $('.obfuscate-email-address .asenha-subfields').show();
         $('.asenha-toggle.obfuscate-email-address td .asenha-field-with-options').addClass('is-enabled');  
      } else {
         $('.obfuscate-email-address .asenha-subfields').hide();        
      }

      // Email Address Obfuscator => show/hide subfields on toggle click
      document.getElementById('admin_site_enhancements[obfuscate_email_address]').addEventListener('click', event => {
         if (event.target.checked) {
            $('.obfuscate-email-address .asenha-subfields').fadeIn();
            $('.obfuscate-email-address .asenha-field-with-options').toggleClass('is-enabled');
         } else {
            $('.obfuscate-email-address .asenha-subfields').hide();
            $('.obfuscate-email-address .asenha-field-with-options').toggleClass('is-enabled');
         }
      ...
      // View Admin as Role => show/hide password input on document ready
      if ( document.getElementById('admin_site_enhancements[view_admin_as_role]').checked ) {
         $('.view-admin-as-role .asenha-subfields').show();
         $('.asenha-toggle.view-admin-as-role td .asenha-field-with-options').addClass('is-enabled');  
      } else {
         $('.view-admin-as-role .asenha-subfields').hide();        
      }

      // View Admin as Role => show/hide password input input on toggle click
      document.getElementById('admin_site_enhancements[view_admin_as_role]').addEventListener('click', event => {
         if (event.target.checked) {
            $('.view-admin-as-role .asenha-subfields').fadeIn();
            $('.view-admin-as-role .asenha-field-with-options').toggleClass('is-enabled');
         } else {
            $('.view-admin-as-role .asenha-subfields').hide();
            $('.view-admin-as-role .asenha-field-with-options').toggleClass('is-enabled');
         }
